const allowedPositiveWords = ["super", "happy", "amazing", "awesome", "exciting"];
const allowedNegativeWords = ["sad", "horrible", "sick", "angry", "unhappy", "disappoint"];
...
const sentimentScoreObject = getSentimentScore('I am a angry super awesome happy');
